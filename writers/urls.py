...
urlpatterns = [
    ...
    path('my_worry_detail/<int:worry_id>', my_worry_detail, name='my_worry_detail'),
    path('worry_ing/<int:worry_id>', worry_ing, name='worry_ing'),
    path('worry_completed/<int:worry_id>', worry_completed, name='worry_completed'),
    path('delete_worry/<int:worry_id>', delete_worry, name='delete_worry'),
    path('my_answer/<int:answer_id>', my_answer_detail, name='my_answer'),
    ...
    path('get_point_logs/', get_point_logs, name='get_point_logs'),
]
